...
### 193 sources in the database, each with a confidence level
...
Average score: **43.08 over 103 scored projects** broadened (rounded 43; FILDA-only: 42.9 over 50 scored → rounded 43, the figure cited in the published article). Banco Sol is tracked but `evidence_complete = 0` / unscored. Under v2-2026-07 (distinct-type event points + confidence-weighted evidence bonus + 17 operational-without-progress downgrades + 2026-08-04 Tier 1 cleanup + 2026-08-04 Tier 3 AIPEX/refinery/multilateral cohorts + 2026-08-10 data-integrity fixes + 2026-08-10 multilateral cohort expansion + 2026-08-11 AIPEX/PPP/multilateral cohorts + 2026-08-11 third multilateral cohort + 2026-08-11 fourth multilateral cohort + 2026-08-11 fifth multilateral cohort).

| Range | Count | % | Interpretation |
|-------|-------|---|----------------|
| 0-20 | 28 | 27.2% | No evidence of execution beyond announcement |
| 21-40 | 20 | 19.4% | Initial or partial execution |
| 41-60 | 19 | 18.4% | Operational but no traceable timeline in sources consulted |
| 61-80 | 27 | 26.2% | Substantive execution with verifiable results |
| 81-100 | 9 | 8.7% | Strong execution with documented results |
...
| Average score 43 (FILDA-only, 50 scored) / 43 (broadened, 103 scored) | calculated | projects.execution_score | n/a | formula-derived (FILDA-only avg 42,9; broadened 43,08 → rounded 43; Banco Sol unscored) |
| 63 projects tracked (62 scored) | count | projects | n/a | direct count (evidence_complete) |
| Distribution table 16/14/1/10/9 (FILDA-only) / 28/20/19/27/9 (broadened) | calculated | projects grouped by score | n/a | formula-derived |
| Sector table | calculated | projects grouped by sector | n/a | formula-derived (Agriculture 16,4; Energy 32,4; Manufacturing 67,0; Infrastructure 36,0; Technology 57,3; Multi-sector 52,0) |
| Gov vs private (54,0 vs 42,8 broadened; FILDA-only 54,0 vs 42,2) | calculated | projects by sector | n/a | derived from 103 scored obs (government = `Government` sector, 3 projects; private = other 100) |
...
15. ~~**Add a "last_verified" date per project**~~ — resolved. All 104 projects carry a `last_verified` date (a human last checked status against sources); source liveness is auto-checked separately by `db/verify_sources.py`.