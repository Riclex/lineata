...
### 192 sources in the database, each with a confidence level
...
| Gov vs private (54,0 vs 42,7 broadened; FILDA-only 54,0 vs 42,2) | calculated | projects by sector | n/a | derived from 103 scored obs (government = `Government` sector, 3 projects; private = other 100) |
