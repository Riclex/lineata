...
| State | Events | Detail |
|-------|--------|--------|
| Linked to a specific source | 163 | grounded to a full-URL article or a named publisher |
...
Average score: **42.98 over 99 scored projects** broadened (rounded 43; FILDA-only: 42.9 over 50 scored → rounded 43, the figure cited in the published article). Banco Sol is tracked but `evidence_complete = 0` / unscored. Under v2-2026-07 (distinct-type event points + confidence-weighted evidence bonus + 17 operational-without-progress downgrades + 2026-08-04 Tier 1 cleanup + 2026-08-04 Tier 3 AIPEX/refinery/multilateral cohorts + 2026-08-10 data-integrity fixes + 2026-08-10 multilateral cohort expansion + 2026-08-11 AIPEX/PPP/multilateral cohorts + 2026-08-11 third multilateral cohort + 2026-08-11 fourth multilateral cohort).

| Range | Count | % | Interpretation |
|-------|-------|---|----------------|
| 0-20 | 28 | 28.3% | No evidence of execution beyond announcement |
| 21-40 | 18 | 18.2% | Initial or partial execution |
| 41-60 | 20 | 20.2% | Operational but no traceable timeline in sources consulted |
| 61-80 | 24 | 24.2% | Substantive execution with verifiable results |
| 81-100 | 9 | 9.1% | Strong execution with documented results |
...
| Gov vs private (54,0 vs 42,6 broadened; FILDA-only 54,0 vs 42,2) | calculated | projects by sector | n/a | derived from 99 scored obs (government = `Government` sector, 3 projects; private = other 96) |
