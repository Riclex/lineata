...
| Average score 43 (FILDA-only, 50 scored) / 44 (broadened, 62 scored) | calculated | projects.execution_score | n/a | formula-derived (FILDA-only avg 42,9; broadened 43,5 → rounded 44; Banco Sol unscored) |
