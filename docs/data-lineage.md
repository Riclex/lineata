...
### 169 sources in the database, each with a confidence level
...
|-----------|---------|-------|
| high | 84 | official outlets, government portals, primary org sites (Sonangol, ANPG, BFA, AIPEX, CIPRA, CIP, Portugal.gov.pt, INACOM, GGPEN, BAI Europa, AEP, ApexBrasil, ETU Energias, Portugal Global/AICEP, Angop, World Bank, AfDB) — 9 sources (135, 136, 141–147) regraded medium→high on 2026-08-10 per the documented convention (official/primary outlets grade high); 6 more (153–157, 159, World Bank/AfDB) added high on 2026-08-10; 12 more (ids 160–171, AIPEX 2026 + PPP concession cohorts) added high on 2026-08-11 |
...
4. **`db/verify_invariants.py`** (40 structural checks) + **`db/verify_snapshot.py`** (auto-generated snapshot + FILDA-only article pin) replaced the old `db/verify.py`. The snapshot is committed as `db/snapshot.json` and regenerated with `--update`. After the v2-2026-07 formula change, 17 operational-without-progress downgrades (2026-08-03), the Tier 1 dataset cleanup, the Tier 3 cohorts (AIPEX + refinery + multilateral) + source_program schema (2026-08-04), the 2026-08-10 data-integrity fixes (ESEEP re-source, announced_value unit normalization, source metadata fill + confidence regrade, safcomex province, PDAC/MOSAP3 event re-grounding), the 2026-08-10 Tier 3 multilateral cohort expansion (7 projects: HCIP, ESIAP, HEPRR, PADA, Secondary Cities, Economic Diversification, Luanda ST Park), the 2026-08-11 AIPEX 2026 cohort (10 projects: 5 award-winner underlying projects + 5 contracts of intent), and the 2026-08-11 PPP concession cohort (5 projects: AIAAN airport, Namibe Corridor, AD Ports Luanda terminal, Sogester Cabinda/Soyo terminals, Caio deep-water terminal), the broadened-DB figures are: 85 tracked / 84 scored, 169 sources / 149 events (148 linked / 1 NULL), avg 42,0 over the 84 scored (rounded 42), distribution 26/18/11/20/9, gov/private 54,0 vs 41,6. The **FILDA-only figures** (51 tracked / 50 scored, avg 43, dist 16/14/1/10/9) are unchanged and are what the published articles cite — `verify_snapshot.check_articles` pins to the FILDA-only avg so adding non-FILDA cohorts doesn't break the article pin. Exits non-zero on any drift.
